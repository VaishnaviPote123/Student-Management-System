...
class Student():
     def __init__(self, root):
        ...
        Manage_Frame.place(x=20,y=100,width=450,height=785)
   ...
   # =========2nd Detials  Frame==================
        Detials_Frame = Frame(self.root, bd=4, relief=RIDGE, bg="red")
        Detials_Frame.place(x=500, y=100, width=1000, height=685)

        lbl_search = Label(Detials_Frame, text="Search By", bg="yellow", fg="black",font=("times new roman", 20, "bold"))
...
#========== table frame ===========
        ...
        Table_Frame.place(x=10, y=70, width=960, height=600)
